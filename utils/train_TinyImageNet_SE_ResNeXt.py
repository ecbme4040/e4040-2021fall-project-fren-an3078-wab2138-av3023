...
def tinyImageNet_ResNeXt_train(model,path,X_train,y_train,X_val,y_val,data_aug=False,learning_rate=0.6,steps=20,epochs=60,batch_size=128,es_patience=15):
