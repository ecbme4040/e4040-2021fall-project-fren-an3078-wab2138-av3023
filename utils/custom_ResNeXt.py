...
def custom_ResNeXt(ResNeXt_model=[],custom_input=(224,224,3),n_classes=1000,cardinality=32,model_name='custom_ResNeXt',debug=False):
    ...
    def split_layer(x, filters, kernel_sizes, strides, name = ''):
        ...
        return tf.concat(all_splits, axis = 3)
